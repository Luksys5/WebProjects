...
export default ({
    'PayPal': {
        id: 'PayPal-btn', className: 'share-btn', tooltipClassName:'tooltip', iconClassName: 'fab fa-cc-paypal', 
        tooltipText: 'Support our site via PayPal!', iconColor: '#8AD4DF',
        iconClick: () => window.open('https://www.paypal.me/vescalc', '_blank')
    },
    'FbShare': {
        id: 'FbShare-btn', className: 'share-btn', tooltipClassName:'tooltip', iconClassName: 'fab fa-facebook', 
    ...
    'FbLike': {
        id: 'FbLike-btn', className: 'share-btn', tooltipClassName:'tooltip', iconClassName: 'fas fa-thumbs-up', 
    ...
    'GPlus': {
        id: 'GoogleShare-btn', className: 'share-btn', tooltipClassName:'tooltip', iconClassName: 'fab fa-google-plus-g',
    ...
    'Twitter': {
        id: 'Twitter-btn', className: 'share-btn', tooltipClassName:'tooltip', iconClassName: 'fab fa-twitter',
