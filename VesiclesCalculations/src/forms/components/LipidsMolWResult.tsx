    ...
    render() {
        ...
        <div className='lipid-result extend--width'>
            ...
            <LineChart data={ results.data } margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                ...
                { showLine !== ShowLine.molWeight && <Line name='Lipids count in vesicle' type='monotone' dataKey='lipidsInVesicle' stroke='black' /> }
                { showLine !== ShowLine.lipidsCount && <Line name='Lipids molecular weight' type='monotone' dataKey='lipidsTotalMolW' stroke='#8884d8' /> }
            </LineChart>
            </ResponsiveContainer>
